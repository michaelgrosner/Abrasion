...
Options:
  --engine=    Search engine to use. Defaults to 'google'. Also supports:
               'bing', 'yahoo', 'twitter', 'ask', 'blekko'
  --nresults=  Number of results to serve back. Defaults to 10. Twitter API maxes
	             out at 100.
	--site=      Search within a specific domain i.e. search all "Google" articles on
	             'engadget.com'. Not supported on 'twitter'.
...
def searchFromBash():
	...
	opts, args = getopt.getopt(sys.argv[2:], 'f', ['engine=', 'nresults=', 'site='])
